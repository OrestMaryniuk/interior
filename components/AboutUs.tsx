    ...
    <Section id="about" className="bg-theme-secondary justify-center">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <h2 className="text-xl md:text-6xl font-heading font-bold mb-6 text-theme-primary">
              {t.about.title} <br />
              <span className="text-theme-accent">{t.about.titleAccent}</span>
            </h2>
            <p className="text-theme-secondary text-xs md:text-lg mb-6 leading-relaxed">
              {t.about.description1}
            </p>
            <p className="text-theme-secondary text-xs md:text-lg leading-relaxed">
